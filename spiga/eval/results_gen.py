...
from ..data.loaders import dl_config as dl_cfg
from  ..data.loaders import dataloader as dl
from ..inference import pretreatment as pretreat
...
class Tester:
    ...
    def __init__(self, model_framework, database, anns_type='test'):
        ...
        self.result_path = os.path.join('spiga', 'eval/results')
