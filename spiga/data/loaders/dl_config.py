...
db_img_path =os.path.join(current_path,"databases")
db_anns_path=os.path.join(current_path,"annotations","{database}/{file_name}.json")
# Default data paths
#db_img_path = "spiga/data/annotations/300wpublic"
#db_anns_path = "spiga/data/annotations/300wpublic/db_info.json"
